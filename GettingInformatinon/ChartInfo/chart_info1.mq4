void OnStart() 
  { 
   Alert("Symbol=",Symbol()); 
   Alert("Low day price=",MarketInfo(Symbol(),MODE_LOW)); 
   Alert("High day price=",MarketInfo(Symbol(),MODE_HIGH)); 
   Alert("The last incoming tick time=",(MarketInfo(Symbol(),MODE_TIME))); 
